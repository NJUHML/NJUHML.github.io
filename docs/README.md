...
features:
  - title: 水文气象数值模拟
    details: 使用数值模式和人工智能算法，对城市内涝，地表径流，河流水量等进行模拟和预报。

  - title: AI气象模型
    details: 研发基于生成式模型的同化与预报AI气象大模型，研究主流气象大模型，对模型架构进行改良，开展多尺度天气预报和气候预测。

  - title: 深度学习算法
    details: 利用机器学习和深度学习，结合个领域传统算法，使用transformer、diffusion、CNN等模型进行空间降尺度（超分）、数值模式偏差订正、时间序列分析等。
